...
.error{
  color: red;
        ...
        <div class="main">
            <h1 align="center">Department wise Detailed Reports</h1>
      ...
      <div class="container">
         <form action="detailed-dept-logic.php" method="post" class="form-welcome">
         ...
         <?php
          ...
          <?php
                                ...
                                // Retrieve the data from your database
                                $sql = "SELECT DISTINCT dept FROM adminconfig5";
                                $result = mysqli_query($con, $sql);

                                // Build the select options
                                echo '<select name="dept" id="dept" required>';
                                echo '<option value="">--select--</option>';
                                while ($row = mysqli_fetch_assoc($result)) {
          ...
          <?php
                                ...
                                // Retrieve the data from your database
                                $sql = "SELECT DISTINCT sem FROM adminconfig5";
                                $result = mysqli_query($con, $sql);

                                // Build the select options
                                echo '<select name="sem" id="sem" required>';
                                echo '<option value="">--select--</option>';
                                while ($row = mysqli_fetch_assoc($result)) {
    ...
    <footer>
    <p>&copy; Designed and Developed by Dept.Of CSD (2021-2024) @muse, mys <br /> Visit : <a href="https://uni-mysore.ac.in/">Mysore University School of Engineering, Mysuru</a></p>
</footer>
