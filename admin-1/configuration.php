           ...
           <table class="table table-borderless">
                 ...
                 <tr>
                  ...
                  <td><select name="dept" id="dept" required>
                          ...
                          <option name="cse" value="COMPUTER SCIENCE AND ENGINEERING">CSD</option>
                          <option name="civil" value="CIVIL ENGINEERING" >AIDS</option>
                          <option name="ece" value="ELECTRONICS AND COMMUNICATION ENGINEERING">AIML</option>
                          <option name="mechanical" value="MECHANICAL ENGINEERING">BMRE</option>
