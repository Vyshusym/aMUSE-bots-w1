...
<div class="header-div"style="background-color:rgb(40,45,126); height:8%; border-bottom:12px solid #000">
        <header style="display: grid;align-items: center; grid-template-columns: 1fr 6fr;">
            ...
            <h1 style="color: white;text-align: center;  font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;margin-left:400px;margin-top:70px;"><b>MYSORE UNIVERSITY SCHOOL OF ENGINEERING</b></h1> 
            <h1 style="color: white;text-align: center;font-size:x-large;margin-left:450px;margin-top:120px;"><b>ಮೈಸೂರು ಯೂನಿವರ್ಸಿಟಿ ಸ್ಕೂಲ್ ಆಫ್ ಇಂಜಿನಿಯರಿಂಗ್</b></h1>
            </div>
        </header>
    </div>
